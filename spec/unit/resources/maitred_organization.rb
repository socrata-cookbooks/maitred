...
shared_context 'resources::maitred_organization' do
  include_context 'resources'

  let(:resource) { 'maitred_organization' }
    ...
    context 'the :create action' do
      ...
      shared_examples_for 'any property set' do
        it 'creates the organization' do
          expect(chef_run).to create_maitred_organization(name).with(
            full_name: full_name || '',
            user: user,
            file: file
          )
    ...
    context 'the :remove action' do
      ...
      shared_examples_for 'any property set' do
        it 'removes the organization' do
          expect(chef_run).to remove_maitred_organization(name)
        end
      end
